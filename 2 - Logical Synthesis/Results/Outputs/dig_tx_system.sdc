...
# Created by write_sdc on Wed May 14 22:02:00 2025

###################################################################
set sdc_version 2.1

set_units -time ns -resistance MOhm -capacitance fF -voltage V -current uA
set_operating_conditions -max ss0p7v125c -max_library saed32hvt_ss0p7v125c\
                         -min ff1p16vn40c -min_library saed32lvt_ff1p16vn40c
set_driving_cell -lib_cell NBUFFX32_RVT -library saed32rvt_ss0p7v125c -pin Y   \
[get_ports i_dig_tx_system_clk32]
set_driving_cell -lib_cell NBUFFX32_RVT -library saed32rvt_ss0p7v125c -pin Y   \
[get_ports i_dig_tx_system_clk26]
set_driving_cell -lib_cell NBUFFX2_RVT -library saed32rvt_ss0p7v125c -pin Y    \
[get_ports i_dig_tx_system_rst_n]
set_driving_cell -lib_cell NBUFFX2_RVT -library saed32rvt_ss0p7v125c -pin Y    \
[get_ports i_dig_tx_system_data_in]
set_driving_cell -lib_cell NBUFFX2_RVT -library saed32rvt_ss0p7v125c -pin Y    \
[get_ports i_dig_tx_system_csn]
...
group_path -name INOUT  -from [list [get_ports i_dig_tx_system_clk32] [get_ports                      \
i_dig_tx_system_clk26] [get_ports i_dig_tx_system_rst_n] [get_ports            \
i_dig_tx_system_data_in] [get_ports i_dig_tx_system_csn]]  -to [list [get_ports o_dig_tx_system_data_out] [get_ports                     \
o_dig_tx_system_crc_valid] [get_ports o_dig_tx_system_regfile_valid]           \
[get_ports o_dig_tx_system_output_valid] [get_ports                            \
{o_dig_tx_system_data_slave_out[7]}] [get_ports                                \
{o_dig_tx_system_data_slave_out[6]}] [get_ports                                \
{o_dig_tx_system_data_slave_out[5]}] [get_ports                                \
{o_dig_tx_system_data_slave_out[4]}] [get_ports                                \
{o_dig_tx_system_data_slave_out[3]}] [get_ports                                \
{o_dig_tx_system_data_slave_out[2]}] [get_ports                                \
{o_dig_tx_system_data_slave_out[1]}] [get_ports                                \
{o_dig_tx_system_data_slave_out[0]}] [get_ports o_dig_tx_system_done]          \
[get_ports o_dig_tx_system_miso_ena] [get_ports o_dig_tx_system_miso]]
group_path -name INREG  -from [list [get_ports i_dig_tx_system_clk32] [get_ports                      \
i_dig_tx_system_clk26] [get_ports i_dig_tx_system_rst_n] [get_ports            \
i_dig_tx_system_data_in] [get_ports i_dig_tx_system_csn]]
group_path -name REGOUT  -to [list [get_ports o_dig_tx_system_data_out] [get_ports                     \
o_dig_tx_system_crc_valid] [get_ports o_dig_tx_system_regfile_valid]           \
[get_ports o_dig_tx_system_output_valid] [get_ports                            \
{o_dig_tx_system_data_slave_out[7]}] [get_ports                                \
{o_dig_tx_system_data_slave_out[6]}] [get_ports                                \
...
set_clock_groups  -asynchronous -name sys_clock_1  -group [list [get_clocks    \
sys_clock] [get_clocks sys_gated_clk]] -group [list [get_clocks spi_clock]     \
[get_clocks spi_gated_clk]]
